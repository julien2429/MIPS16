...
HD_PWD='C:/Users/Julie/OneDrive/Desktop/CA/MIPS/MIPS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MipsTopLevel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MipsTopLevel.tcl
