...
HD_PWD='C:/Users/Julie/OneDrive/Desktop/CA/MIPS/MIPS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MipsTopLevel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MipsTopLevel.tcl -notrace
